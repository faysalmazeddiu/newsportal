...
<body style="background:#fff;">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/front/jSlider/js/jssor.core.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/front/jSlider/js/jssor.utils.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/front/jSlider/js/jssor.slider.js"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; width: 720px;
        ...
        foreach ($slider_pics as $pic) {
            ...
            <div>
                <a href="#" target="_blank"><img u="image" src="<?php echo $image_file_location; ?>" /></a>
				<div class="caption"><?php echo $pic['caption']; ?></div>	
                 <img u="thumb" src="<?php echo $image_file_location; ?>" />   
